...
## Timeline, preset, and project-library verification

On 13 August 2026, the repeatable browser workflow was extended and passed for the new editor controls. It persisted a 100 ms–1,000 ms selected-clip range through `video.setClipTrim`, renamed the project to `E2E Timeline Studio`, searched for and reopened it from the project library, selected the Thai Story subtitle preset, completed an assembled 16:9 edit, and deleted the project. The final regression run completed with 32 Vitest tests and a clean TypeScript check.
